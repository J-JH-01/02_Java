...
public class FileService {
	...
	public void method1() {
		...
		if( !directory.exists()) { //폴더가 존재하지 않으면
			...
			directory.mkdirs(); //make directorys
	...
	public void method2() {
		...
		// -> 역슬래시 자체를 문자로(\이거 표현하고싶을때) 사용하고 싶을땐 2개 사용 \\
	...
	public void method3() {
		...
		System.out.println(Arrays.toString(files)); //files라는 배열의 모든 요소 출력
...
//			System.out.println(date);
			...
			String result = String.format("%-20s %-20s, %-4s %10s",
	 ...
	 * 하지만 폴더/파일 생성 및 삭제한느 것은 입출력 작업이 아닌
