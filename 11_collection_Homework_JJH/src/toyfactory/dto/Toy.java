...
public class Toy {
	...
	private String manufactureDate; //제조일(문자열로 표현 - 202402222)
	...
	public String getMaterialsAsString() {
		...
		if(materials.size() == 0) return "없음";
		// 재료가 있다면 materials 순회하면서 재료 하나하나, 로 구분하여 문자열 만들기
		for( String material : materials) {
			sb.append(material).append(", "); //문자열 뒤에 이어 쓰기
		}
		
		// ex) "고무, 면직물"
		
		//만들어진 문자열의 마지막 쉼표와 곰백 제거
	...
	public String toString() {
		String material = String.join(", ", materials);
		return "이름 : " + name + " / " + "가격 : " + price + " / " + "색상 : " + color + " / " + "사용가능연령 : " + age + " / "
				+ "제조년월일 : " + manufactureDate + " / " + "재료 : " + material ;
	}
