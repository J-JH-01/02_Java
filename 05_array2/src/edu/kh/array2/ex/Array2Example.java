...
public class Array2Example {
	...
	/**
	 *
	 * -자료형이 같은 1차원 배열을 묶음으로 다룬느 것 -> 행, 열 개념 추가
	 */
...
//		2 행의 합 : 24
	...
	public void ex3() {
		...
		// 나중에 서로 큭기ㅏ 다른 1차원 배열을 생성하여 참조하는 배열
