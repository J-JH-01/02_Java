package edu.kh.network.server.model.dto;
...
//		1)서버의 포트번호 정함
		...
		// 단 , 1023이하는 이미 사용중인 경우가 많으니 피하는게 좋음
		...
		// 입/출력용 참조변수 선언
		InputStream is = null; // 둘 다 최상위 클래스로 선언해 준것임
		OutputStream os = null;
		
		
		// 보조스트림 참조변수 선언 (성능 향상용)
		BufferedReader br = null; //입력용
		PrintWriter pw =null;
...
//			6)보조 스트림을 통해 성능 개선
			...
			// 바이트기반 InputStream을 함께 연결할 수 있도록
...
//			8)통신 종료
			try {
				...
				// 스트림/소켓 닫기
				if(br != null) br.close(); // + is.close() 도 함께됨
