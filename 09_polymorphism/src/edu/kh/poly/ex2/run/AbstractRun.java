...
import edu.kh.poly.ex2.model.service.HDGCalculator;
import edu.kh.poly.ex2.model.service.JJHCalculator;

public class AbstractRun {

	public static void main(String[] args) {

		new AbstractService().ex3();
		
		// ==============================================================
		
		Calculator cal = new JJHCalculator();
		...
		Calculator cal2 = new HDGCalculator();
		...
		// 2) 자식 클래스에 공통된 메서드를 장제 구현 하라고 하기때문에
