...
public class InheritanceService {
	...
	public void ex1() {
		...
		//Person을 상송받은 Student가
		// 정말로 Person의 필드, 메소드를 사용할 수 있는가?
	...
	public void ex2() {
		...
		//Student 객체 생성
		Student std = new Student("김철수",17,"ROK",1,3);
	...
	public void ex3() {
		...
		std.move(); // 오버라이딩 X -> Person(부모)의 메서드 수행 , "사람은 움직일 수 있다"
		emp.move(); // 오버라이딩 O -> Employee에서 재정의한 메서드 수행, "효율적으로 빨리 일하고 퇴근한다"
